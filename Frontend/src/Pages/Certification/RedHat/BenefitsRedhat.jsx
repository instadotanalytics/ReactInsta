...
const BenefitsRedhat = () => {
  ...
  useEffect(() => {
    ...
    const blobs = [
      { x: 0.15, y: 0.2, r: 0.28, color: 'rgba(147,197,253,0.18)', dx: 0.00012, dy: 0.00008 },
      { x: 0.82, y: 0.75, r: 0.24, color: 'rgba(196,181,253,0.14)', dx: -0.0001, dy: 0.00009 },
      { x: 0.5,  y: 0.5,  r: 0.20, color: 'rgba(186,230,253,0.13)', dx: 0.00007, dy: -0.00011 },
      { x: 0.75, y: 0.18, r: 0.18, color: 'rgba(165,180,252,0.12)', dx: -0.00009, dy: 0.00007 },
      { x: 0.25, y: 0.8,  r: 0.22, color: 'rgba(147,197,253,0.15)', dx: 0.00011, dy: -0.00006 },
    ];
      ...
      <div className={styles.container}>
        ...
        <div className={styles.constellation}>
          ...
          <div className={styles.cardTop}>
            <div className={styles.floatCard} data-size="sm">
              ...
              <div className={styles.uptimeStat}>
                <span className={styles.uptimeNum}>99.999<span className={styles.uptimePct}>%</span></span>
                <span className={styles.uptimeSub}>5-nines availability</span>
              </div>
              <div className={styles.uptimeBar}>
                <div className={styles.uptimeBarFill} style={{ width: '99.999%' }} />
              </div>
          ...
          <div className={styles.cardLeft}>
            <div className={`${styles.floatCard} ${styles.floatCardTall}`} data-size="md">
              <div className={styles.cardHeader}>
                <span className={styles.cardIcon}>
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round">
              ...
              <div className={styles.securityRing}>
                <svg viewBox="0 0 80 80" className={styles.ringsvg}>
                  <circle cx="40" cy="40" r="32" fill="none" stroke="#E0EFFE" strokeWidth="6"/>
                  <circle cx="40" cy="40" r="32" fill="none"
                    stroke="url(#secGrad)" strokeWidth="6"
                    strokeDasharray="200.96" strokeDashoffset="20"
                  ...
                  <text x="40" y="37" textAnchor="middle" fontSize="13" fontWeight="700" fill="#3B82F6">FIPS</text>
                  <text x="40" y="51" textAnchor="middle" fontSize="9" fill="#93BBDB">140-2</text>
                </svg>
              </div>
          ...
          <div className={styles.centerHero}>
            <div className={styles.heroInner}>
              ...
              <p className={styles.heroSub}>
                Trusted by thousands of enterprises to power digital transformation
                with secure, scalable infrastructure.
              </p>
          ...
          <div className={styles.cardRight}>
            <div className={`${styles.floatCard} ${styles.floatCardTall}`} data-size="md">
              ...
              <div className={styles.cloudChips}>
                {['On-Premise', 'Multi-Cloud', 'Edge'].map(env => (
              ...
              <div className={styles.deployMetric}>
                <span className={styles.deployNum}>60<span className={styles.deployPct}>%</span></span>
          ...
          <div className={styles.cardBottom}>
            <div className={styles.floatCard} data-size="sm">
              ...
              <p className={styles.costCaption}>Open source eliminates proprietary dependencies</p>
            </div>
          </div>
